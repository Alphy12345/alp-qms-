...
from app.routers import project, assembly, part, document, balloon, measurement, pdf_annotation, note, report, view_region, bluetooth, auth
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        from app.models.auth import create_default_admin_user
        db = SessionLocal()
        try:
...
# Add explicit CORS handling middleware to ensure headers on all responses
@app.middleware("http")
